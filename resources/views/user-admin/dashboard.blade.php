...
@section('title','Dashboard Superadmin JDIH (Jaringan Dokumentasi dan Informasi Hukum) Kabupaten Maluku Barat Daya')
@section('content')
    <main>
        <!-- Main page content-->
                ...
                <div class="card-body p-5">
                    <div class="row align-items-center justify-content-between">
                        <div class="col">
                            ...
                            <p class="text-gray-700">Great job, your affiliate dashboard is ready to go! You
                    ...
                    <div class="card border-start-lg border-start-success h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-2"><i class="fas fa-mouse-pointer fa-2x text-gray-200"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body text-center p-5">
                            ...
                            <p class="mb-4">Ready to get started? Let us know now! It's time to start
